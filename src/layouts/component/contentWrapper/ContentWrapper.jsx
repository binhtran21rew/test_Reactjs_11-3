            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            className={`Content_title_moreImage ${
                                rotate && "text-end"
                            }`}
                        >
                            {moreImage ? (
...
const CustomContent = ({ ...props }) => {
    ...
    return textPosition ? (
        <div
            className={`CustomContent row ${
                widthScreen < 780 ? "" : "d-flex flex-column w-100 h-100"
            }  `}
        >
            <div
                className={`col-md-6 ${
                    widthScreen < 780
                        ? "w-100"
                        : "d-flex h-50 w-50 justify-content-center"
                } `}
            >
                <div
                    className={`d-flex ${
                        widthScreen < 780 ? "w-100 flex-wrap" : "flex-wrap w-75"
                    }`}
                >
                    {textHighlight ? (
            ...
            <div
                className={`col-md-6 ${
                    widthScreen < 780
                        ? "w-100"
                        : "d-flex flex-wrap w-100 justify-content-end"
                } pt-3`}
            >
                <div
                    className={`row d-flex ${
                        widthScreen < 780 ? "w-100" : "w-50 align-items-center"
                    } flex-column `}
                >
                    {detail && (
